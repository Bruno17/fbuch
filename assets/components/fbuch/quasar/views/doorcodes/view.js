...
export default {
    ...
    setup() {
        ...
        const columns = [
            ...
            { name: 'Member_firstname', label: 'Vorname', field: 'Member_firstname', sortable: true, align:'left' },
            { name: 'Member_member_status', label: 'Status', field: 'Member_member_status', sortable: true, align:'left' },
            { name: 'Aktionen', label: 'Aktionen', field: 'Aktionen', sortable: false }
        ]
        const visible_columns = ref(['Code_time_setting','Code_blocked','code','Member_name','Member_firstname','Member_member_status','Aktionen']);
