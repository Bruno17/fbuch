...
export default {
  ...
  setup(props) {
    ...
    function loadEntry(){
      ...
      var data = {};
      var ajaxUrl = modx_options.rest_url + 'Bootsettings/' + id;
    ...
    function prepareSettings(){
      ...
      for (let i=0; i<boat.value.seats; i++) {
        entry.value.settings[i] = entry.value.settings[i]||{};
        entry.value.settings[i]['MIGX_id'] = i+1;
      }
    ...
    function save() {
      ...
      if (id == 'new') {
        const ajaxUrl = modx_options.rest_url + 'Bootsettings';
        ...
        const ajaxUrl = modx_options.rest_url + 'Bootsettings/' + id;
